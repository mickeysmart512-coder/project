...
const EmailVerify = ({ navigation }) => {
  ...
  const handleNext = () => {
    // Logic to send OTP to the user's email and navigate to OTP screen
  };
    ...
    <View style={styles.container}>
      ...
      <View style={styles.bottomContainer}>
        ...
        <View style={styles.iconContainer}>
          <MaterialIcons name="mail-outline" size={100} color="#3B82F6" />
        </View>
        <Text style={styles.infoText}>An OTP will be sent to this email</Text>
